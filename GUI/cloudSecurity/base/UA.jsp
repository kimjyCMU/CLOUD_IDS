...
function ajaxdata(indexIP){
	var ajaxResult="";     
	document.getElementById("UA").value=indexIP;     
...
var valUA = ["normal", "flooding", "APIabuse", "spoofing", "bruteforce","ProtocolManipulation","injection","analysis"];
console.log(valUA);
